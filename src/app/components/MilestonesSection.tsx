...
const MILESTONES = [
  ...
  {
    date: "2026 — Present",
    title: "Backend Web Developer & District Manager @ Team System Hunter Taskforce",
    desc: "Leading backend development and district operations for a cybersecurity-focused organization. Building scalable web infrastructure and managing team coordination.",
    tags: ["Django", "Backend", "Cybersecurity", "Management"],
