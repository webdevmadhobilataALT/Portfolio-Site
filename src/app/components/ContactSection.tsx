...
export function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs
      .send(
        "service_9orey7f",       // Service ID
        "template_k77ms11",     // Template ID
        {
          name: form.name,
          email: form.email,
          ...
          <div className="col-lg-4">
            <div className="cyber-card mb-4" style={{ height: "auto" }}>
              ...
              <p className="cyber-card-text mb-4">
                Got a Django project, need API help, want automation scripting,
              ...
              >
                <div
                  style={{
                    ...
                    marginBottom: "1.5rem",
                    boxShadow:
                      "0 0 12px rgba(0,240,255,0.5), 0 0 32px rgba(0,240,255,0.25)",
                    position: "relative",
                  }}
                >
                  <div
                    style={{
                      ...
                      fontWeight: 700,
                      textShadow:
                        "0 0 8px #00f0ff, 0 0 18px rgba(0,240,255,0.8)",
                      fontFamily: "var(--font-mono)",
                ...
                <p className="cyber-card-text">
                  Your signal reached the terminal.
                  I'll transmit a response within 24 hours.
                  Stand by.
                </p>
